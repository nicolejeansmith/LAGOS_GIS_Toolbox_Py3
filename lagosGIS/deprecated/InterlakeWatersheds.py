...
def interlake_watersheds(nhd, watersheds, topoutfolder, filterlakes):
    ...
    try:
        ...
        arcpy.Project_management(filterlakes, filtershp)
        arcpy.SelectLayerByLocation_management(waterbody_lyr, "INTERSECT", filterlakes, '', "SUBSET_SELECTION")
